...
/* 
Todos los Forms deal-related tiene un authorId y un dealId. El User autor del Form debe tener relación con ese deal (UserDeals.userId = Forms.authorId y UserDeals.dealId = Forms.dealId). De no ser así deben transferirse al owner del deal (Forms.authorId = Deals.ownerId)
*/
...
// Función para listar formularios donde el authorId ya no está asociado al deal, junto con el owner del deal
async function listFormsWithNoExistingRelatedUser() {
  await connectDatabases();
